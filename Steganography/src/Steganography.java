...
"Target File cannot hold message!", "Error",JOptionPane.ERROR_MESSAGE);
	 ...
	 */
	private byte[] encode_text(byte[] image, byte[] addition, int offset) //offset send the chunk of bytes 
               
	{                                                                     // either in 1 or 4 bytes text 
		//check that the data + offset will fit in the image           // embeding into images
